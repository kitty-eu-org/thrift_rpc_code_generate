...
//int main()
//{
//    string out_path = "/root/cpp_thrift/";
//    string input_file_path = "/root/cpp_thrift/text1.thrift";
//    string language = "py";
...
//BOOST_PYTHON_MODULE(libthrift){
////    def("generate_code", generate_code);
//    boost::python::def("generate_code", generate_code);
//}
...
PYBIND11_MODULE(thrift_code, m) {
    m.doc() = R"pbdoc(
            Pybind11 example plugin
            -----------------------
            .. currentmodule:: thrift
            .. autosummary::
               :toctree: _generate
               generate_code
        )pbdoc";

    m.def("generate_code", &generate_code, R"pbdoc(
            Add two numbers
